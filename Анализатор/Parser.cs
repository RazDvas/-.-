...
namespace Анализатор
{
    internal class Parser
    {
        ...
        private void Expression()
        {
            ...
            ValidateAndBuildMatrix(outputQueue, ref matrix);
        ...
        private void ValidateAndBuildMatrix(Queue<Token> rpn, ref List<string> matrix)
        {
            int ind = 1;
            ...
            foreach (var token in rpn)
            {
                ...
                else if (IsOperator(token.Type))
                {
                    ...
                    string matrixEntry = $"M{ind++}: {token.Value} {operand1} {operand2}";
                    tempStack.Push($"M{ind - 1}");
